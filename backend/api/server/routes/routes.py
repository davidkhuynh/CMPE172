...
def user(username: str, page: int=1):
    ...
    """
    return "user page for username: %s, page: %i" (username, page)

@app.route("/following/<username>/<int:page>", methods=["GET"])
...
@app.route("/followers/<username>/<int:page>", methods=["GET"])
